namespace Game_AVP2.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CharacterItems", "Character_CharacterId", "dbo.Characters");
            ...
            DropForeignKey("dbo.Abilities", "StaticCharacterId", "dbo.StaticCharacters");
            ...
            DropIndex("dbo.CharacterItems", new[] { "Character_CharacterId" });
            ...
            DropIndex("dbo.Abilities", new[] { "StaticCharacterId" });
